...
import {TagEntry, TopicUrls} from './tag-entry'


function tag(name: string, logo?: string, webSite?: string, related?: TagEntry[], urls?: TopicUrls, logoTipoWide?: boolean) {
  return new TagEntry(name, logo, webSite, related, urls, undefined, undefined, logoTipoWide);
}
...
export class TopicsService {
  ...
  public topics: TagEntry[] = this.transformTags([
   ...
   materialDesign, typeScript,
    ...
    tagLogoTipo('PWA'), tagNoIcon('SPA'), tag('REST', null), tag('HTTP', null), tag('WebSocket'), 'WebRTC', tagLogoTipo('Upwork'),
    ...
    tagLogoTipo('Groovy'), 'GWT', 'Haskell', tagNoIcon('Elixir'), 'Erlang',
    ...
    'Electron',
    tagNoIcon('MyBatis'),
    'Gradle', tagLogoTipo('Maven'), 'Grails',
    'Neo4j', 'Hadoop',
